/*
 ...
 This code of distribution is the result of converting the SEP3.R file in 'gamlss.dist' package, version 6.0-5 by Rigby et.al (2022). This code is based on the DHalfCauchy.cc  (Copyright (C) 2018 Matthew Denwood <matthewdenwood@mac.com>). This file is part of neojags. 
